...
\begin{pro}\label{13.1.11}
	...
	\end{align*}
	\begin{center}
		\framebox{\enquote{Transponieren heißt Komponenten dualisieren.}}
	\end{center}
\end{pro}
\begin{cproof}
...
\begin{cproof} $\Phi$ ist als Hintereinanderschaltung zweier Vektorraumisomorphismen ebenfalls ein Vektorraumisomorphismen:
	% TODO: Fix illegal argument in array argument.
	\begin{align*}
		\begin{array}{cols=5}
		...
		\end{array}
		%\Bil(V)&\stackrel{\substack{[\to\ref{13.3.7}\\\cong]}}{\longrightarrow}
		%\Hom(V,V^*)&\stackrel{\substack{[\to\ref{7.1.8}\\\cong]}}{\longrightarrow}K^{n\times n}\\
		%b&\mapsto\lvec b&\mapsto M(\lvec b,\v,\v^*)\stackrel{\ref{13.3.7}}{=}M(b,\v).
	\end{align*}
