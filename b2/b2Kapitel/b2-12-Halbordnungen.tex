...
Sei $A$ eine durch Inklusion halbgeordnete Menge von Mengen derart, dass für jede nichtleere Kette $C\subseteq A$ gilt \case{$\bigcup C\in A$}{$\bigcap C\in A$}. Dann gibt es zu jedem $M\in A$ ein \case{maximales}{minimales} $N\in A$ mit \case{$M\subseteq N$}{$ N\subseteq M$}.
\end{kor}
